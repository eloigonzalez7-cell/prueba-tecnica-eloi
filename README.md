...
**Current release:** [`v1.2.5`](https://github.com/eloigonzalez7-cell/prueba-tecnica-eloi/releases/tag/v1.2.5) — see [CHANGELOG.md](CHANGELOG.md).
...
| Doc | Description |
|-----|-------------|
| [docs/BACKLOG.md](docs/BACKLOG.md) | Epic backlog (S00–S41; E10–E12 = GFT review) |
