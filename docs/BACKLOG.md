...
| E8 | Cypress e2e + smoke | S33–S35 | Done (`v0.7.0-tests`; suite expanded on `v1.1.0`) |
| E9 | Delivery docs (README, ADRs, traceability) | S36–S37 | Done (`v1.0.0`; milestones through `v1.1.0`) |

Current delivery tag: **`v1.1.0`** (hardening + structured Cypress).
